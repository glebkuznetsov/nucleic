...
@memoize
def calc_dna_params(na_conc=0.05, mg_conc=0.00001):
    ''' Return the thermo parameters for DNA under specified salt cond. 

    Adapted from Pythia / Noble et al 2009. 
    Thermodynamic data from SantaLucia and Hicks, 2004. 
        Enthalpies are given in kcal/mol
        Entropies are given in cal/molK
    ...
    na_equivalents = (1000. * na_conc + 120. * math.sqrt(mg_conc * 1000.))/1000.
    # From SantaLucia and Hicks, 2004
    ds_correction = 0.368 * math.log(na_equivalents)
